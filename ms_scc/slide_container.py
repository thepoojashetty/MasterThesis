...
class SlideContainer:
    def __init__(self, file: Path,
                 ...
                 sample_func = None, label_dict=None,test_only=False):
        self.file = file
        ...
        self.x_max, self.y_max = np.max(
            ...
            axis=0)
        self.width = self.slide.level_dimensions[self._level][0] if test_only else width
        self.height = self.slide.level_dimensions[self._level][1] if test_only else height
